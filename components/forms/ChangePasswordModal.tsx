          ...
          <ModalBody>
            ...
            <form onSubmit={form.handleSubmit((values:any)=>onSubmit(values,onClose))} className="space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className='font-bold text-[13px] text-slate-600 dark:text-gray-300'>Current Password</FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className='font-bold text-[13px] text-slate-600 dark:text-gray-300'> Password</FormLabel>
                    <FormControl>
                      <Input placeholder="Atleast 8 characters" type="password" {...field} />
                    </FormControl>
                    <FormMessage />
              ...
              <Button isLoading={pending} className='text-[15px] font-medium  text-white bg-blue-600' type="submit" radius='sm'>Change Password</Button>
