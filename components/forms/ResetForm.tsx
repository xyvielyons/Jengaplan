    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className='font-bold text-[13px] text-slate-600 dark:text-gray-300'>New Password</FormLabel>
              <FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className='font-bold text-[13px] text-slate-600 dark:text-gray-300'>Confirm Password</FormLabel>
              <FormControl>
                <Input placeholder="Atleast 8 characters" {...field} type='password'/>
              </FormControl>
              <FormMessage />
        ...
        <Button isLoading={pending} className='bg-[#007AFF] w-full text-[15px] font-medium text-white' type="submit" radius='sm'>Change Password</Button>
      </form>
    </Form>
  )
}
