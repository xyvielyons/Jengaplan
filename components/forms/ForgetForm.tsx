    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className='font-bold text-[13px] text-slate-600 dark:text-gray-300'>Email</FormLabel>
              <FormControl>
        ...
        <Button isLoading={pending} className='w-full text-[15px] font-medium text-white bg-[#007AFF]' type="submit" radius='sm'>Send Recovery Email</Button>
      </form>
    </Form>
  )
}
