    ...
    <div className='flex flex-col gap-2'>
        ...
        <div className="flex-row flex gap-4">
            <div className="w-full">
                <Button isLoading={pendingGithub} onClick={handleSignInWithGithub} className='w-full bg-gray-200 dark:text-gray-800' startContent={<FaGithub className='w-[24px] h-[24px]' />} radius='sm'>Github</Button>
            </div>
            <div className="w-full">
