...
const AuthNav = (props: Props) => {
  ...
  return (
    <div className="bg-white/80 dark:bg-background/80 w-full ">
        <nav className='fixed bg-white/80 dark:bg-background/80 border-b-1 border-b-slate-200 h-[56px] w-full flex items-center px-4 justify-between dark:border-b-gray-800 z-[100]'>
