'use client'
import { getBankInformationTypes, getPdfsTypes } from '@/lib/types'
...
const DashboardCards = ({bankInfo,pdfs}: Props) => {
      ...
      <div className="gap-2 flex flex-col md:flex-row">
        ...
        <Card className='dark:bg-background w-full'>
          <CardHeader>
            <CardTitle className='flex items-center gap-4'>
              <BadgeDollarSign size={24} className='text-gray-800 dark:text-gray-300'/>
              <h1 className='text-sm text-gray-800 dark:text-gray-300'>Schemes generated</h1>
            </CardTitle>
          </CardHeader>
          <CardContent className='space-y-2'>
