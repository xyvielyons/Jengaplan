  ...
  return (
    <div className="flex flex-col md:flex-row mt-[32px] p-4 relative h-full">
      ...
      <div className="pt-6 pb-2 px-4 space-y-[28px] md:w-1/2 md:p-8 lg:p-16">
        ...
        <div>
          <h1 className="text-4xl font-bold text-gray-800 dark:text-gray-100">Change Password</h1>
        ...
        <div className="">
          <span className='text-sm text-gray-600 dark:text-gray-300'>Dont have an account? <Link href="/sign-up" className='text-gray-800 font-semibold hover:text-gray-500 active:text-gray-500 dark:text-gray-50 dark:hover:text-gray-600'>Register</Link></span>
        </div>
      </div>
